...
import { ConsumerCsvReport } from "./ConsumerReportCsv";
import { InspectorCompound } from './InspectorCompound';
...
const BLOCK_START = parseInt(process.env.BLOCK_START || '11003919');
