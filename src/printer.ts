...
import { ArbitrageProposal } from "./types";
//
...
export async function printArbitrageProposals(provider: providers.JsonRpcProvider, arbitrageProposals: Array<ArbitrageProposal>): Promise<void> {
